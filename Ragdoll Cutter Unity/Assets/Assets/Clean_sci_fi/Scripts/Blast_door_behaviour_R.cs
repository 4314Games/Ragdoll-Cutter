...
public class Blast_door_behaviour_R : MonoBehaviour {
		...
		if (openOrClose == true)
			{
				...
				targetGameObject.GetComponent<Animation>().CrossFade ("B_Door_R_open");
		...
		else
			{
				...
				targetGameObject.GetComponent<Animation>().CrossFade ("B_Door_R_close");
