...
public class Lift_gate_R: MonoBehaviour {
		...
		if (openOrClose == true)
			{
				...
				targetGameObject.GetComponent<Animation>().CrossFade ("Lift_gate_R_Close");
		...
		else
			{
				...
				targetGameObject.GetComponent<Animation>().CrossFade ("Lift_gate_R_Open");
